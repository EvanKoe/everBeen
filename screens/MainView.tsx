...
import {getAllCountries, getContinents, getCountryIsoFromName} from "../functions/countries.ts";
...
const MainView = () => {
  ...
  useEffect(() => {
    ...
    setMapUrl(newUrl);
    getAllCountries().then((countries: []) => setCountryList([ ...countries ]));
  }, []);
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      >
        <Dropdown
          data={getContinents(countryList)}
          labelField="label"
          valueField="value"
